...
|---|---|---|
| `add` | integer:a integer:b ⇒ integer:a+b | adds two integers |
...
| `mark` | ∅ ⇒ mark | mark |
| `mul` | integer:a integer:b ⇒ integer:a*b | multiplies two integers |
...
| `sub` | integer:1 integer:0 ⇒ integer | substracts two integers (integer:1 - integer:2) |
